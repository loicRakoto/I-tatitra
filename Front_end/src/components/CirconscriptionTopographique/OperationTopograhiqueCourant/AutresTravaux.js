...
import TableAutresTravaux from '../../Tableaux/TableAutresTravaux';



function AutresTravaux() {
    ...
    const initialTravauxExpertise = 0;
    const initialDelimitation = 0;
    const initialLevePlanEnsemble = 0;
    const initialAssistanceConstatation = 0;
    const initialAutres = 0;

    const [situations, setSituations] = useState(initialSituations);

    const [TravauxExpertise, setTravauxExpertise] = useState(initialTravauxExpertise);
    const [Delimitation, setDelimitation] = useState(initialDelimitation);
    const [LevePlanEnsemble, setLevePlanEnsemble] = useState(initialLevePlanEnsemble);
    const [AssistanceConstatation, setAssistanceConstatation] = useState(initialAssistanceConstatation);
    const [Autres, setAutres] = useState(initialAutres);

    const formData = {
        situations: situations,

        travauxExpertise: TravauxExpertise,
        delimitation: Delimitation,
        levePlanEnsemble: LevePlanEnsemble,
        assistanceConstatation: AssistanceConstatation,
        autres: Autres,
    ...
    const handleSubmitTravauxBornage = async (e) => {
        ...
        const api = "http://127.0.0.1:8000/api/ChefCirconsctiptionTopo/OperationTopoCourant/Add/AutresTravaux";
        try {
            ...
            setTravauxExpertise(initialTravauxExpertise);
            setDelimitation(initialDelimitation);
            setLevePlanEnsemble(initialLevePlanEnsemble);
            setAssistanceConstatation(initialAssistanceConstatation);
    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="row">
                    <TableAutresTravaux userId={userId} isLoading={isLoading} setIsLoading={setIsLoading} envoiDate={envoiDate} setetatTableaux={setetatTableaux} etatTableaux={etatTableaux} CirconscriptionId={userCirconscriptionId} />
                </div>
                    ...
                    <div className="modal-dialog modal-xl">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="travauxBornageLabel">Autres travaux</h5>
                                    ...
                                    <div className="card mt-4">
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">Travaux d'expertise</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={TravauxExpertise} onChange={(e) => setTravauxExpertise(e.target.value)} />
                                                    </div>
                                                </div>
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">Délimitation</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={Delimitation} onChange={(e) => setDelimitation(e.target.value)} />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">Levé de plan d'ensemble</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={LevePlanEnsemble} onChange={(e) => setLevePlanEnsemble(e.target.value)} />
                                                    </div>
                                                </div>
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">Assistance de constatatation</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={AssistanceConstatation} onChange={(e) => setAssistanceConstatation(e.target.value)} />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
