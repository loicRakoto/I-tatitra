...
import TableSurfacesBornees from '../../Tableaux/TableSurfacesBornees';


function SurfaceBorne() {
    ...
    const initialBornageIndividuel = 0;
    const initialBornageCollectif = 0;

    const [situations, setSituations] = useState(initialSituations);

    const [BornageIndividuel, setBornageIndividuel] = useState(initialBornageIndividuel);
    const [BornageCollectif, setBornageCollectif] = useState(initialBornageCollectif);


    const formData = {
        situations: situations,
        bornageIndividuel: BornageIndividuel,
        bornageCollectif: BornageCollectif,
    ...
    const handleSubmitTravauxBornage = async (e) => {
        ...
        const api = "http://127.0.0.1:8000/api/ChefCirconsctiptionTopo/OperationTopoCourant/Add/SurfaceBorne";
        try {
            ...
            setBornageIndividuel(initialBornageIndividuel);
            setBornageCollectif(initialBornageCollectif);
    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="row">
                    <TableSurfacesBornees isLoading={isLoading} setIsLoading={setIsLoading} envoiDate={envoiDate} setetatTableaux={setetatTableaux} etatTableaux={etatTableaux} CirconscriptionId={userCirconscriptionId} />
                </div>
                    ...
                    <div className="modal-dialog modal-xl">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="travauxBornageLabel">Surface bornées</h5>
                                ...
                                <form onSubmit={handleSubmitTravauxBornage}>
                                    <div className="input-group input-group-sm mb-3">
                                        ...
                                        <select className="form-select" id="inputGroupSelect01" value={situations} onChange={(e) => setSituations(e.target.value)}>
                                            <option value="0" defaultValue>Bornées</option>
                                        </select>
                                    </div>
                                    <div className="card mt-4">
                                        ...
                                        <div className="card-body">
                                            <div className="row">
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">Bornage individuel</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={BornageIndividuel} onChange={(e) => setBornageIndividuel(e.target.value)} />
                                                    </div>
                                                </div>
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">Bornage collectif</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={BornageCollectif} onChange={(e) => setBornageCollectif(e.target.value)} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
