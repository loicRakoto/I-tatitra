...
import TableDematerialisation from '../../Tableaux/TableDematerialisation';



function Dematerialisation() {
    ...
    const initialPlanCadastrale = 0;
    const initialPvcb = 0;
    const initialPlanReperage = 0;
    ...
    const [PlanCadastrale, setPlanCadastrale] = useState(initialPlanCadastrale);
    const [Pvcb, setPvcb] = useState(initialPvcb);
    const [PlanReperage, setPlanReperage] = useState(initialPlanReperage);
    ...
    const handleSubmitTravauxBornage = async (e) => {
        ...
        const api = "http://127.0.0.1:8000/api/ChefCirconsctiptionTopo/TravauxDeModernisation/Add/Dematerialisation";
        try {
            ...
            setPlanCadastrale(initialPlanCadastrale);
            setPvcb(initialPvcb);
            setPlanReperage(initialPlanReperage);
    ...
    return (
        <>
            ...
            <div>
                ...
                <div className="row">
                    <TableDematerialisation isLoading={isLoading} setIsLoading={setIsLoading} envoiDate={envoiDate} setetatTableaux={setetatTableaux} etatTableaux={etatTableaux} CirconscriptionId={userCirconscriptionId} />
                </div>
                    ...
                    <div className="modal-dialog modal-xl">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="travauxBornageLabel">Dématerialisation</h5>
                                ...
                                <form onSubmit={handleSubmitTravauxBornage}>
                                    <div className="input-group input-group-sm mb-3">
                                        ...
                                        <select className="form-select" id="inputGroupSelect01" value={situations} onChange={(e) => setSituations(e.target.value)}>
                                            <option value="0" defaultValue>Restaurés</option>
                                            <option value="1">Scannés</option>
                                            <option value="2">Vectorisés</option>
                                        </select>
                                    </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        ...
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={PlanCadastrale} onChange={(e) => setPlanCadastrale(e.target.value)} />
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">PVC / Jorm</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={Pvcb} onChange={(e) => setPvcb(e.target.value)} />
                                                    </div>
                                                </div>
                                                <div className="col">
                                                    <div className="input-group input-group-sm mb-3">
                                                        <span className="input-group-text" id="inputGroup-sizing-sm">Plan de reperage</span>
                                                        <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value={PlanReperage} onChange={(e) => setPlanReperage(e.target.value)} />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
