...
function TableRapportActiviteNational({ envoiRegion, isLoading, setIsLoading, etatTableaux, setetatTableaux, envoiDate }) {
    ...
    useEffect(() => {
        if (etatTableaux === 0 && envoiDate !== '' && envoiRegion !== '') {
            //Dernier enregistrement de toute les activité de cirtopo
            const api = "http://127.0.0.1:8000/api/rapportActivite/nationale";
            actualisationTableau(api);

        }
        else if (etatTableaux === 1 && envoiDate !== '' && envoiRegion !== '') {
            //Recherche date
            const api = "http://127.0.0.1:8000/api/RechercheRapportActiviteNationale/nationale";
            actualisationTableau(api);
    ...
    }, [etatTableaux, actualisationTableau, setIsLoading, envoiDate, envoiRegion]);
                ...
                <div className="container-tableau mt-3">
                    <table className="table table-hover tableau">
                        ...
                        <thead className='titre-tableau'>
                            <tr className="tr1">
                                <th colSpan={3}></th>
                                <th className='title-region' colSpan={TotalColonneDistrict + 1} >{envoiRegion}</th>
                            </tr>
                            <tr className="tr2">
...
export default TableRapportActiviteNational