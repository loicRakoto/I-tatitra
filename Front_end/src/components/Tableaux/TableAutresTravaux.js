...
function TableAutresTravaux({ isLoading, setIsLoading, CirconscriptionId, etatTableaux, setetatTableaux, envoiDate }) {
            ...
            {!isLoading && (
                <div className="container-tableau mt-3">
                    <table className="table table-hover tableau">
                        ...
                        <tbody>
                            <tr>
                                <th className='soustitre-tableau'>Travaux d'éxpertise</th>
                                <td> {a1}</td>
                                <td> {b1}</td>
                                <td> {c1}</td>
                                <td> {d1}</td>
                            ...
                            <tr>
                                <th className='soustitre-tableau'>Délimitation</th>
                                <td> {a2}</td>
                                <td> {b2}</td>
                                <td> {c2}</td>
                                <td> {d2}</td>
                            ...
                            <tr>
                                <th className='soustitre-tableau'>Levé de plan ensemble</th>
                                <td> {a3}</td>
                                <td> {b3}</td>
                                <td> {c3}</td>
                                <td> {d3}</td>
                            ...
                            <tr>
                                <th className='soustitre-tableau'>Assistance de constatatation d'état des lieux</th>
                                <td> {a4}</td>
                                <td> {b4}</td>
                                <td> {c4}</td>
                                <td> {d4}</td>
...
export default TableAutresTravaux