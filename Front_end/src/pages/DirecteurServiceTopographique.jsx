...
import NavigationDirecteurTopo from '../layout/Dst/NavigationDirecteurTopo';
    ...
    return (
        ...
        <div className={`dashboard ${isOpen ? 'open' : 'closed'}`}  >
            ...
            <header className="menu-wrap">
                ...
                <NavigationDirecteurTopo pageName={setNomPage} pageClicked={setCurrentPage} />
            </header>
...
export default DirecteurServiceTopographique