...
import NavigationChefRegionTopo from '../layout/Dst/NavigationChefRegionTopo';
...
import RapportActiviteRegionale from '../components/CirconscriptionTopographique/Visualisation/RapportActiviteRegionale';




function ChefServiceRegionaleTopographique() {
    ...
    switch (currentPage) {
        case "PageRapportAct":
            pageContent = <RapportActiviteRegionale nomRegion={nomRegion} />;
            break;
...
export default ChefServiceRegionaleTopographique